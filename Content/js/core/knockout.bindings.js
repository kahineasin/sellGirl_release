...
(function ($, ko) {
    ...
    ko.creatEasyuiValueBindings = function (o) {
        ...
        var customBinding = {
            ...
            update: function (element, valueAccessor, allBindingsAccessor, viewModel, bindingContext) {
                ...
                //jqElement(element)[o.type](o.setter, o.formatter(value));//原
                //try {
                    if (o.type == 'combobox') {
                        var data = jqElement(element)[o.type]('options').data;//by wxj
                        for (var i in data) {
                            if (data[i].value == o.formatter(value)) {
    ...
    ko.creatEasyuiValueBindings({ type: 'combobox', event: 'onChange' });//by wxj
