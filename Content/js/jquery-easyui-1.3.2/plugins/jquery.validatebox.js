...
(function ($) {
    ...
    $.fn.validatebox.defaults = {
        required: false, validType: null, delay: 200, missingMessage: "This field is required.", invalidMessage: null, tipPosition: "right",
        rules: {
            email: {
            ...
            regexRemote: {
                ...
                validator: function (value, param) {
                    ...
                    if (param[0] instanceof Array) {
                        ...
                        var elem = $(param[0]);
                        item = elem.combobox('options').data;
                    }
                    for (var o in item) {
                        if (item[o].text == value) {
                            //if ((!(param[0] instanceof Array))&&elem.combobox('getValue')!=item[o].value) {
                            //    elem.combobox('setValue', item[o].value);
                            //}
