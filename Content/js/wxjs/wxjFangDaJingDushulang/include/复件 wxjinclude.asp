...
function cgalview()
  ...
  if picid="" then
    ...
    strPicSource=picid
	 ...
	 response.Write "<div id='content'><h2 id='header'></h2><div style='float: left; width:356px; height:205px; background:url("&strPicSource&") no-repeat; border:1px solid gray; margin-right: 1em; margin-bottom: 0.25em;'><img id='caribbean' onLoad='initLoupe(this.id,true,773,364);' src='"&strPicSource&"' style='cursor:wait;' width='356' height='205' alt='large image' border='0' /></div></div>"
