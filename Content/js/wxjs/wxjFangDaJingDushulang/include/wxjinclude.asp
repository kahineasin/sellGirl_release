...
function cgalview()
  ...
  if picid="" then
    ...
    strPicSource=picid
	 ...
	 'response.Write "<div id='main_line_right_prozm_con_l'><a class='two' id='proimg_a' href='img/activity_new1.jpg' ><img style='width:583px;height:348px;' alt='dogface' id='idProShowPic' src='"&rs("slidepicpart1")&"' border='0'/></a></div>"
	 response.Write "<div id='content'><h2 id='header'></h2><div style='float: left; width:460px; height:280px; background:url("&strPicSource&") no-repeat; border:1px solid gray; margin-right: 1em; margin-bottom: 0.25em;'><img id='caribbean' onLoad='initLoupe(this.id,true,573,430);' src='"&strPicSource&"' style='cursor:wait;' width='460' height='280' alt='large image' border='0' /></div></div>"
...
function cgalview_backup()
  ...
  dim rs,sql
  if picid="" then
      sql="select top 1 * from pp_News where ViewFlag and SortID=212 order by id asc"
  else
      sql="select top 1 * from pp_News where ViewFlag and SortID=212 order by id asc"
    'strPicSource=picid
  end if
  ...
  set rs = server.createobject("adodb.recordset")
	 ...
	 'response.Write "<div id='main_line_right_prozm_con_l'><a class='two' id='proimg_a' href='img/activity_new1.jpg' ><img style='width:583px;height:348px;' alt='dogface' id='idProShowPic' src='"&rs("slidepicpart1")&"' border='0'/></a></div>"
	 'response.Write "<div id='content'><h2 id='header'></h2><div style='float: left; width:770px; height:370px; background:url("&strPicSource&") no-repeat; border:1px solid gray; margin-right: 1em; margin-bottom: 0.25em;'><img id='caribbean' onLoad='initLoupe(this.id,true,573,430);' src='"&strPicSource&"' style='cursor:wait;' width='460' height='280' alt='large image' border='0' /></div></div>"
	 
	 'old
	 'response.Write "<div style='width:600; height:500px; margin-right: 1em; margin-bottom: 0.25em;'><img id='caribbean' onLoad='initLoupe(this.id,true,573,430);' src='"&strPicSource&"' style='cursor:wait;' width='439' height='328' alt='large image' border='0' /></div>"
	 'response.Write "<div style='width:600; height:500px; margin-right: 1em; margin-bottom: 0.25em;'><img id='caribbean' onLoad='initLoupe(this.id,true,573,430);' src='"&strPicSource&"' style='cursor:wait;' width='439' height='328' alt='large image' border='0' /></div>"
	 'ok
	 response.Write "<div style='float: left; width:500px; height:330px;  margin-right: 1em; margin-bottom: 0.25em;'><img id='caribbean' onLoad='initLoupe(this.id,true,773,364);' src='../"&strPicSource&"' style='cursor:wait;' width='500' height='330' alt='large image' border='0' /></div>"
...
function handpadview()
  ...
  if picid="" then
      'sql="select top 1 * from pp_cgal where ViewFlag and SortID=36 order by id asc"
	  sql="select top 1 * from pp_cgal where id=65 order by id asc"
      rs.open sql,conn,1,3
        if rs.bof and rs.eof then
            response.write "<div>暫無相關信息</div>"
        else
    ...
    strPicSource=picid
	 ...
	 'response.Write "<div id='main_line_right_prozm_con_l'><a class='two' id='proimg_a' href='img/activity_new1.jpg' ><img style='width:583px;height:348px;' alt='dogface' id='idProShowPic' src='"&rs("slidepicpart1")&"' border='0'/></a></div>"
	 response.Write "<div id='content'><h2 id='header'></h2><div style='float: left; width:750px; height:400px; background:url("&strPicSource&") no-repeat; border:1px solid gray; margin-right: 1em; margin-bottom: 0.25em;'><img id='caribbean' onLoad='initLoupe(this.id,true,573,430);' src='"&strPicSource&"' style='cursor:wait;' width='750' height='400' alt='large image' border='0' /></div></div>"
...
'cgal生成iframe
Function wxjCgalIframe()
	If Request.QueryString("id")<>"" Then
		
		Set rs=server.CreateObject("adodb.recordset")
		rs.open "select top 1 * from pp_cgal where id="&Request.QueryString("id")&" and ViewFlag",conn,1,3
		If rs.eof Then
		Else
			Response.Write("<iframe name='leftframe' id='leftframe' width='680px;' height='420px' frameborder='0' allowtransparency=true marginwidth='0px' marginheight='0px' frameborder='0px' scrolling='no' style='background-color:transparent;background:none;overflow:hidden;' scroll='none' src='iframe_pro.asp?picid="&rs("slidepicpart1")&"'></iframe>")
		End If
	Else
		Response.Write("<iframe name='leftframe' id='leftframe' width='680px;' height='420px' frameborder='0' allowtransparency=true marginwidth='0px' marginheight='0px' frameborder='0px' scrolling='no' style='background-color:transparent;background:none;overflow:hidden;' scroll='none' src='iframe_pro.asp'></iframe>")
	End If
End Function
'Handpad生成iframe
Function wxjHandpadIframe()
	If Request.QueryString("id")<>"" Then
		...
		If rs.eof Then
		Else
			Response.Write("<iframe name='leftframe' id='leftframe' width='958px;' height='600px' frameborder='0' allowtransparency=true marginwidth='0px' marginheight='0px' frameborder='0px' scrolling='no' style='background-color:transparent;background:none;overflow:hidden;' scroll='none' src='iframe_handpad.asp?picid="&rs("slidepicpart1")&"'></iframe>")
		End If
	Else
		Response.Write("<iframe name='leftframe' id='leftframe' width='958px;' height='600px' frameborder='0' allowtransparency=true marginwidth='0px' marginheight='0px' frameborder='0px' scrolling='no' style='background-color:transparent;background:none;overflow:hidden;' scroll='none' src='iframe_handpad.asp'></iframe>")
	End If
End Function
'cgal下列表
function cgallistzm()
...
function proshowlistzm()
	...
	Else
		...
		'If rs.eof Then Exit For
        '不用框架
		'response.Write "<li><a class='pro_a' ptxt='"&rs("content")&"' pname='"&rs("productname")&"' psrc='"&rs(strSlidePic1)&"' phref='productshow.asp?sid="&rs("sortid")&"&id="&rs("id")&"'><img style='width:119px;height:70px;' src='"&rs(strSlidePic1)&"' onclick='document.getElementById(""caribbean"").src=this.src'/></a></li>"
		'用框架
        response.Write "<li><a class='pro_a' ptxt='"&rs("content")&"' pname='"&rs("productname")&"' psrc='"&rs(strSlidePic1)&"' href='iframe_pro.asp?picid="&rs(strSlidePic1)&"' target='leftframe' phref='productshow.asp?sid="&rs("sortid")&"&id="&rs("id")&"'><img style='width:119px;height:70px;' src='"&rs(strSlidePic1)&"'/></a></li>"
...
function handpadshowlistzm()
	...
	Else
		...
		'response.Write "<li><a class='pro_a' ptxt='"&rs("content")&"' pname='"&rs("productname")&"' psrc='"&rs(strSlidePic1)&"' phref='productshow.asp?sid="&rs("sortid")&"&id="&rs("id")&"'><img style='width:119px;height:70px;' src='"&rs(strSlidePic1)&"' onclick='document.getElementById(""caribbean"").src=this.src'/></a></li>"
		'用框架
        response.Write "<li><a class='pro_a' ptxt='"&rs("content")&"' pname='"&rs("productname")&"' psrc='"&rs(strSlidePic1)&"' href='iframe_handpad.asp?picid="&rs(strSlidePic1)&"' target='leftframe' phref='handpadshow.asp?sid="&rs("sortid")&"&id="&rs("id")&"'><img style='width:119px;height:70px;' src='"&rs(strSlidePic1)&"'/></a></li>"
...
Function cgalleft()
	...
	Else
		...
		Do While Not rs.eof
			...
			Else
				If rs("id")=65 Then
					'Response.Write("<a class='divProLeftBtnNor' href='handpad.asp?id="&rs("id")&"'>"&rs("ProductName")&"</a>")
				Else
...
Function wxjProFangDaJing()
  ...
  if rs.bof and rs.eof then
    response.write "<div>暫無相關信息</div>"
      ...
      'dim BigPic
	 ' BigPic=rs("BigPic2")
	 strSlidePic=rs("slidepicpart1")
	 response.Write ("<div class='zoomybox'><a id='idProShowPicA' class='zoom' href='"&replace(strSlidePic,"../","")&"'><img id='idProShowPic' style='width:540px;height:360px;' src='"&rs("slidepicpart1")&"'/></a></div>")
...
Function wxjHandpadContent()
	'newsid=request.queryString("newsid")
	Set rs=server.CreateObject("adodb.recordset")
	rs.open "Select * from pp_cgal where id=65",conn,1,3
	If rs.eof Then
	Else
		Response.Write(rs("Content"))
	End If
...
End Function
'手提电脑展示页查出产品图
Function wxjHandPadShowImg()
	Dim strRes
	Set rs=server.CreateObject("adodb.recordset")
	rs.open "Select * from pp_news where SortID=211 order by AddTime",conn,1,1
	If rs.eof Then
	Else
		'For i=1 To rs.recordcount
		'strRes=strRes&"<li>"&i&"</li>"
		'Next
		'strRes=strRes&"</ul><div class='sliderbox' id='idTransformView'><ul style='position:relative;' class='slider' id='idSlider'>"
		Do While Not rs.eof
		strRes=strRes&"<li><img src='"&rs("bigPic")&"'/></li>"
...
'手提电脑展示图iframe
Function wxjHandpadShowIframe()
	If Request.QueryString("id")<>"" Then
		sql="select top 1 * from pp_news where SortID=212 and ViewFlag order by AddTime asc"
	...
	End If
		...
		Else
			'此句有效
		Response.Write("<iframe name='leftframe' id='leftframe' width='900px;' height='600px' frameborder='0' allowtransparency=true marginwidth='0px' marginheight='0px' frameborder='0px' scrolling='no' style='background-color:transparent;background:none;overflow:hidden;' scroll='none' src='wxjs/wxjFangDaJingDushulang/iframe_handpad_show_bigpic.asp'></iframe>")
		'Response.Write("<iframe name='leftframe' id='leftframe' width='900px;' height='600px' frameborder='0' allowtransparency=true marginwidth='0px' marginheight='0px' frameborder='0px' scrolling='no' style='background-color:transparent;background:none;overflow:hidden;' scroll='none' src='wxjs/wxjFangDaJingDushulang/homer.html'></iframe>")
		Response.Write("<iframe name='leftframe' id='leftframe' width='900px;' height='600px' frameborder='0' allowtransparency=true marginwidth='0px' marginheight='0px' frameborder='0px' scrolling='no' style='background-color:transparent;background:none;overflow:hidden;' scroll='none' src='homer.html'></iframe>")
			'Response.Write("<iframe name='leftframe' id='leftframe' width='680px;' height='420px' frameborder='0' allowtransparency=true marginwidth='0px' marginheight='0px' frameborder='0px' scrolling='no' style='background-color:transparent;background:none;overflow:hidden;' scroll='none' src='iframe_pro.asp?picid="&rs("slidepicpart1")&"'></iframe>")
		End If
		rs.close
		Set rs=nothing
End Function
'handpadShow列表
function handpadShowlistzm2()
	Set rs=server.CreateObject("adodb.recordset")
	sql="select * from pp_News where SortID=212 and ViewFlag order by AddTime asc"
	rs.open sql,conn,1,3
	...
	Else
		Do While Not rs.eof
        response.Write "<li><a class='pro_a' ptxt='"&rs("Content")&"' pname='"&rs("NewsName")&"' psrc='"&rs("BigPic")&"' href='iframe_handpad_show_bigpic.asp?picid="&rs("BigPic")&"' target='leftframe' phref='productshow.asp?sid="&rs("SortID")&"&id="&rs("ID")&"'><img style='width:80px;height:60px;background:url(img_new/handpad_show_list_btn.jpg) no-repeat;padding:0px 28px;' src='"&rs("BigPic")&"'/></a></li>"
		rs.movenext
		Loop
        'Response.write("<a href='1234' target='_blank'><img src='"&rs(strSlidePic1)&"' width='605' height='361' /><p>"&rs("ProductName")&"</p></a>")
		'rs.movenext
...
End Function
'手提电脑早教知识iframe
Function wxjHandpadMainContent()

	If Request.QueryString("id")<>"" Then
		sql="select top 1 * from pp_news where id="&Request.QueryString("id")&" and ViewFlag order by AddTime asc"
		
	Else
		sql="select top 1 * from pp_news where ID=899 and ViewFlag order by AddTime asc"
	End If
	Set rs=server.CreateObject("adodb.recordset")
	rs.open sql,conn,1,1
	...
	Else
		Do While Not rs.eof
        response.Write "<img src='"&rs("BigPic")&"'>"
		rs.movenext
		Loop
        'Response.write("<a href='1234' target='_blank'><img src='"&rs(strSlidePic1)&"' width='605' height='361' /><p>"&rs("ProductName")&"</p></a>")
		'rs.movenext
