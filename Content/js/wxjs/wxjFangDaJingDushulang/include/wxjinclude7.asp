...
do while not rs.eof
   ...
   '<a href='produceview.asp?sortid="&rs("sortid")&"&id="&rs("id")&"&sortpath="&request("sortpath")&"'>
	response.Write ("<div style='position:relative;' class='divBooklistC1L'><div class='divBooklistC1LImg'><a title='"&ProductName&"' href='"& replace(rs("smallpic"),"../","")&"'><img src='"& replace(rs("smallpic"),"../","")&"'/></a></div><div class='divBooklistC1LC'><a href='"& replace(rs("downloadFile"),"../","")&"'>"&ProductName&"<img style='position:absolute;right:19px;top:109px;float:right;height:13px;' src='img/download_btn.jpg'/></a></div></div>")
	rs.movenext
	If rs.eof Then
		response.Write ("</div>")
	Else
