...
function proshowlistzm()
	...
	Else
		...
		'Response.write("<script type='text/javascript' language='javascript'>alert('"&strSlidePic1&"');</script>")
		'If rs.eof Then Exit For
		response.Write "<li><a class='pro_a' ptxt='"&rs("content")&"' pname='"&rs("productname")&"' psrc='"&rs(strSlidePic1)&"' phref='productshow.asp?sid="&rs("sortid")&"&id="&rs("id")&"'><img style='width:119px;height:70px;' src='"&rs(strSlidePic1)&"' onclick='document.getElementById(""idProShowPic"").src=this.src'/></a></li>"
