...
com.viewModel.edit = function (data) {
    ...
    this.saveClick = function () {
        ...
        com.ajax({
            ...
            success: function (d) {
                if (d.code == 'success') {
                    if (self.fnIsNew()) {//新方法 by wxj
                        data.dataSource.pageData.form = ko.toJS(self.pageData.form);
                        self.fnIsNew = function () { return false; };
                    } else {
        ...
        com.auditDialogForEditVM(self.pageData.form, function (d) {
            com.ajax({
                ...
                success: function (a) {
                    console.info(a);
                    if (a.code == 'success') {
                        com.message(a.code, d.status == "passed" ? self.resx.auditPassed : self.resx.auditReject);
                        ko.mapping.fromJS(self.pageData.form, {}, data.dataSource.pageData.form);
                    } else {
                        com.message(a.code, a.exception.Message);
    ...
    this.init = function () {
        ...
        if (self.fnIsNew()) {
            ...
            //data.dataSource.pageData.form = self.form.defaults;//by wxj
            //data.dataSource.pageData = ko.mapping.fromJS(self.form.defaults);//by wxj
        }
    };
