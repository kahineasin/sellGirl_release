...
* 继承与使用可以参考:E:\mypage\SellGirl\SellGirl.Web\SellGirl.Web\Areas\Jp\Views\CnToHiragana\Index.cshtml
**/
var com = com || {};
...
com.viewModel.searchEdit = function (data) {
    ...
    this.deleteClick = function () {
        ...
        com.message('confirm', self.resx.deleteConfirm, function (b) {
            if (b) {
                com.ajax({
                    type: 'DELETE', url: self.urls.remove + row[self.setting.idField], success: function (c) {
                        com.message(c.code, c.text);
                        self.searchClick();
                    }
                });
            }
